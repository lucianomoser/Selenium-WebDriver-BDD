Feature: ValidacaoRBAALimiteExcedidoEmMais20NoAnoAnteriorValidacaoFevereiro
		 ...
		 E tendo UTRAPASSADO O SUBLIMITE EM MAIS DE 20 PORCENTO de faturamento no EXERCICIO ANTERIOR DECLARADO EM FEVEREIRO
 ...
 Background: 
	...
	| 08  | 2018 | 9650000     | 0              | 0           | 0             | 0      | 0                | 0                    | 0               |
	| 09  | 2018 | 1000000     | 0              | 0           | 0             | 0      | 1                | 1                    | 0               |
	| 10  | 2018 |  100000     | 0              | 0           | 0             | 0      | 0                | 0                    | 0               |
	| 11  | 2018 |  0          | 0              | 0           | 0             | 0      | 0                | 0                    | 0               |
	| 12  | 2018 |  30000      | 0              | 0           | 0             | 0      | 0                | 0                    | 0               |
	| 01  | 2019 |  15000      | 0              | 0           | 0             | 0      | 0                | 0                    | 0               |
	| 02  | 2019 |  10000      | 0              | 0           | 0             | 0      | 1                | 0                    | 1               |
	

	Given que eu selecione a opção de Declaração de Serviços	
	Given que eu solicite uma nova declaração para a competência "02/2019"



Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo III Sem Retencao
	...
	| Prestado   | '15/02/2019' | '1234' | 'A'   | '0'      | '07065385000114' | Não    | '07.02'        | '4212000'        | 'Cerejeiras'       | 100000 |
...
Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo III Com Retencao
	...
	And forneça os seguintes dados para formulário de declaracao de nota	
	| Modalidade | Emissao      | Numero | Serie | Aliquota | TomadorPrestador | Retido | ServicoFederal | ServicoMunicipal | MunicipioPrestacao | Valor  |
	| Prestado   | '15/02/2019' | '1234' | 'A'   | '0'      | '07065385000114' | Sim    | '07.02'        | '4212000'        | 'Cerejeiras'       | 100000 |
...
Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo IV Sem Retencao
...
Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo IV Com Retencao
...
Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo V Sem Retencao
...
Scenario: CEN.03.04 - Validacao RBAA Excedeu o SubLimite Em Mais de 20 Porcento Do Exercicio Anterior Validacao em Fevereiro Do Anexo V Com Retencao
