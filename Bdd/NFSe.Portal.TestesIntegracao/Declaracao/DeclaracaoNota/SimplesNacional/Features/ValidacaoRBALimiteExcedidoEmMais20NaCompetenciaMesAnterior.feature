Feature: ValidacaoRBALimiteExcedidoEmMais20NaCompetenciaMesAnterior
		 ...
		 E tendo UTRAPASSADO O SUBLIMITE de faturamento na COMPETÊNCIA MÊS ANTERIOR
 ...
 Background: 
	...
	Given que eu solicite uma nova declaração para a competência "10/2018"



Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo III Sem Retencao
	...
	| Prestado   | '15/10/2018' | '1234' | 'A'   | '0'      | '07065385000114' | Não    | '07.02'        | '4212000'        | 'Cerejeiras'       | 100000 |
	...
	Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo III Com Retencao
	...
	And forneça os seguintes dados para formulário de declaracao de nota	
	| Modalidade | Emissao      | Numero | Serie | Aliquota | TomadorPrestador | Retido | ServicoFederal | ServicoMunicipal | MunicipioPrestacao | Valor  |
	| Prestado   | '15/10/2018' | '1234' | 'A'   | '0'      | '07065385000114' | Sim    | '07.02'        | '4212000'        | 'Cerejeiras'       | 100000 |
...
Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo IV Sem Retencao
	...
	Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo IV Com Retencao
...
Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo V Sem Retencao
	...
	Scenario: CEN.03.01 - Validacao RBA Excedeu o SubLimite Em Mais de 20 Porcento Na Competencia Anterior Do Anexo V Com Retencao
	...
	Then o status Habilitado para o campo Alíquota deverá ser "false"
	Then o valor do campo Alíquota deverá ser igual a 2,9