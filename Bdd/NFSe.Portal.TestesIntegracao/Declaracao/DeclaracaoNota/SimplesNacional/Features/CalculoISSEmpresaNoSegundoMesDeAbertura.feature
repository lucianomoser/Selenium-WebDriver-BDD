Feature: CalculoISSEmpresaNoSegundoMesDeAbertura
		 ...
		 E desejo declarar a Prestação de Serviço no SEGUNDO MÊS APÓS A DATA DE ABERTURA DA EMPRESA		 
...
Background: 
	...
	Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe III Sem Retencao
	...
	| Prestado   | '01/10/2018' | '1234' | 'A'   | '0'      | '10306984000197' | Não    | '01.01'        | '6202300'        | 'Cerejeiras'       | 100000 |
	...
	Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe III Com Retencao
	...
	And forneça os seguintes dados para formulário de declaracao de nota	
	| Modalidade | Emissao      | Numero | Serie | Aliquota | TomadorPrestador | Retido | ServicoFederal | ServicoMunicipal | MunicipioPrestacao | Valor  |
	| Prestado   | '01/10/2018' | '1234' | 'A'   | '0'      | '10306984000197' | Sim    | '01.01'        | '6202300'        | 'Cerejeiras'       | 100000 |
	...
	Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe IV Sem Retencao
    ...
    Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe IV Com Retencao
    ...
    Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe V Sem Retencao

	Given a seguinte configuração de serviços 
	| ServicoFederal | ServicoMunicipal | Anexo    | RetencaoTomador | SujeitoFatoR | DevidoNoLocal | Aliquota |
	| '01.01'        | '6202300'        | AnexoV   | Não             | Não          | Não           |20.5      |
	...
	Scenario: CEN.02.03 - Calculo ISS Empresa no Segundo mes de abertura Do Anexe V Com Retencao

	Given a seguinte configuração de serviços 
	| ServicoFederal | ServicoMunicipal | Anexo    | RetencaoTomador | SujeitoFatoR | DevidoNoLocal | Aliquota |
	| '01.01'        | '6202300'        | AnexoV   | Sim             | Não          | Não           |20.5      |
